...
class CentroidTracker:
    ...
    def update(self, rects, kpts):
        ...
        for i, (rect, kpt) in enumerate(zip(rects, kpts)):
            ...
            rects_center_dict[self.list_to_number_hash(inputCentroids[i])] = rect
        ...
        # grab the set of object IDs and corresponding centroids
            ...
            for (row, col) in zip(rows, cols):
                ...
                self.objects[objectID]['kpts'] = kpts_center_dict[self.list_to_number_hash(inputCentroids[col])]
            ...
            # register each new input centroid as a trackable object
                ...
                for col in unusedCols:
                    self.register(inputCentroids[col], 
                                  ...
                                  kpts_center_dict[self.list_to_number_hash(inputCentroids[col])])
